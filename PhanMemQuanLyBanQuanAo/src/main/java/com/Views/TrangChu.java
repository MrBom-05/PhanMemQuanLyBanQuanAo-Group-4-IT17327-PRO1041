    ...
    private void loadDataThongKe(List<BillDetailWithProductDetailCustomModel> list) {
        ...
        for (BillDetailWithProductDetailCustomModel billDetailWithProductDetailCustomModel : list) {
            defaultTableModel.addRow(new Object[]{
                    ...
                    billDetailWithProductDetailCustomModel.getTenSP(),
                    billDetailWithProductDetailCustomModel.getLoaiSP(),
                    billDetailWithProductDetailCustomModel.getKichCo(),
                    billDetailWithProductDetailCustomModel.getMauSac(),
                    billDetailWithProductDetailCustomModel.getChatLieu(),
